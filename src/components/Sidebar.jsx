...
// //                 onClick={() => {
// //                   if (!editing) {
// //                     setLocation({ location: "new-product" });
// //                   } else {
// //                     return navigate("/?location=new-product");
// //                   }
// //                 }}
// //               >
...
// //                 onClick={() => {
// //                   if (!editing) {
// //                     setLocation({ location: "tags" }); // Đặt location là 'tags'
// //                   } else {
// //                     navigate("/?location=tags");
// //                   }
// //                 }}
// //               >
...
// //                 onClick={() => {
// //                   if (!editing) {
// //                     setLocation({ location: "suggestion" });
// //                   } else {
// //                     return navigate("/?location=suggestion");
// //                   }
// //                 }}
// //               >
...
// //               <i className="fa-solid fa-arrow-right-to-bracket"></i>Đăng xuất
// //             </button>
// //           </div>
// //         </div>
// //       </div>
...
// // ===== FILE: src/components/Sidebar.jsx (ĐÃ LÀM SẠCH) =====
...
//               <li
//                 onClick={() => {
//                   if (!editing) setLocation({ location: "" });
...
//               <li
//                 onClick={() => {
//                   if (!editing) setLocation({ location: "products" });
//                   else navigate("/?location=products");
//                 }}
//               >
//                 <i className="fa-solid fa-cube"></i>
//                 <p>Sản phẩm</p>
...
//               <li
//                 onClick={() => {
//                   if (!editing) setLocation({ location: "new-product" });
//                   else navigate("/?location=new-product");
//                 }}
//               >
//                 <i className="fa-solid fa-box"></i>
//                 <p>Thêm sản phẩm mới</p>
...
//               <li
//                 onClick={() => {
//                   if (!editing) setLocation({ location: "tags" });
//                   else navigate("/?location=tags");
//                 }}
//               >
//                 <i className="fa-solid fa-tags"></i>
//                 <p>Quản lý Tag (AI)</p>
...
//               <li
//                 onClick={() => {
//                   if (!editing) setLocation({ location: "users" });
//                   else navigate("/?location=users");
//                 }}
//               >
//                 <i className="fa-solid fa-users-cog"></i>
//                 <p>Quản lý Người dùng</p>
...
//               <li
//                 onClick={() => {
//                   if (!editing) setLocation({ location: "suggestion" });
//                   else navigate("/?location=suggestion");
//                 }}
//               >
//                 <i className="fa-solid fa-headset"></i>
//                 <p>Gợi ý AI</p>
